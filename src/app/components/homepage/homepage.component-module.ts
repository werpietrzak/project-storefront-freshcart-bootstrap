...
@NgModule({
  imports: [CommonModule, ProductsServiceModule, FeaturedCategoryComponentModule, CategoriesServiceModule, StoreListGridComponentModule, StoresServiceModule, CategoryListGridComponentModule, CategoriesServiceModule],
